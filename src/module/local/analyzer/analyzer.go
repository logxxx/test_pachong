...
import (
	"fmt"
	"learn/mywebcrawler/helper/log"
	"learn/mywebcrawler/module"
	"learn/mywebcrawler/module/stub"
	"learn/mywebcrawler/toolkit/reader"
)
...
func New(
	...
	for i, parser := range respParsers {
		if parser == nil {
			return nil, genParameterError(fmt.Sprintf("nil responser parser[%d]", i))
